...
class KvsCoordOpsIfSingletonFactory : virtual public KvsCoordOpsIfFactory {
 public:
  ...
  virtual KvsCoordOpsIf* getHandler(const ::apache::thrift::TConnectionInfo&) {
    return iface_.get();
  }
  virtual void releaseHandler(KvsCoordOpsIf* /* handler */) {}
...
class KvsCoordOps_get_result {
 public:
  ...
  KvsCoordOps_get_result() : success() {
  }
...
class KvsCoordOps_keepAlive_result {
 public:
  ...
  KvsCoordOps_keepAlive_result() : success() {
  }
...
class KvsCoordOps_syncComplete_args {
 public:
  ...
  KvsCoordOps_syncComplete_args() : ip() {
  }
...
class KvsCoordOps_syncComplete_result {
 public:
  ...
  KvsCoordOps_syncComplete_result() : success() {
  }
...
class KvsCoordOpsProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  KvsCoordOpsProcessorFactory(const ::std::shared_ptr< KvsCoordOpsIfFactory >& handlerFactory) :
